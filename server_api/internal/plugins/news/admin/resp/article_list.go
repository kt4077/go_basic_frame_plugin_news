...
type ArticleItem struct {
	...
	Content          string              `json:"content" gorm:"column:content" comment:"文章正文"`
	Status           int                 `json:"status" gorm:"column:status" comment:"状态，1草稿，2已发布，3已下线"`
	EnableStatus     int                 `json:"enable_status" gorm:"column:enable_status" comment:"启用状态，1启用，2禁用"`
